...
namespace System.Net.WebSockets
{
    ...
    internal static class WebSocketHelpers
    {
            ...
            ArraySegment<byte> internalBuffer)
        {
            ...
            // ADIADI::WebSocketBuffer.Validate(internalBuffer.Count, receiveBufferSize, 16, true); instead:
            ...
            ArraySegment<byte> internalBuffer)
        {
            ...
            try
            {
                ...
                // response.ComputeCoreHeaders(); //ADIADI :: Headers.SetInternal(HttpResponseHeader.WwwAuthenticate, HttpListenerContext.MutualAuthentication) ?
                ...
                */
                ...
                // ADIADI:: opaq mode ?? does websocket sharp does this ?
                /*
...
/*
                webSocketContext = new HttpListenerWebSocketContext(
                                                                    ...
                                                                    webSocket);
*/
                webSocketContext = new HttpListenerWebSocketContext(context, webSocket);
            }
            catch (Exception ex)
            {
            /*
        ...
        private static unsafe ulong SendWebSocketHeaders(HttpListenerResponse response)
        {
            ...
            return response.SendHeaders(
                System.Net.HttpListenerResponse.HTTP_FLAGS.HTTP_SEND_RESPONSE_FLAG_OPAQUE |
                System.Net.HttpListenerResponse.HTTP_FLAGS.HTTP_SEND_RESPONSE_FLAG_MORE_DATA |
                System.Net.HttpListenerResponse.HTTP_FLAGS.HTTP_SEND_RESPONSE_FLAG_BUFFER_DATA,
                true);
        ...
        {
         // ADIADI:: ensure web socket headers or else throw exception
            /*
        ...
        */
        ...
        internal static void ValidateSubprotocol(string subProtocol)
        {
            ...
            if (invalidChar != null)
            {
                throw new ArgumentException(SR.GetString(SR.net_WebSockets_InvalidCharInProtocolString, subProtocol, invalidChar), "subProtocol");
            }
        }
        /*
        ...
        */
        ...
        internal static void ValidateArraySegment<T>(ArraySegment<T> arraySegment, string parameterName)
        {
            ...
            {
                throw new ArgumentNullException(parameterName + ".Count");
            }
        }
        /*
